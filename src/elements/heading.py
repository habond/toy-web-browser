            ...
            if child.tag == "text" and child.text:
                ...
                if text:
                    ...
                    if text_layout:
                        ...
                        height = (
                            layout_engine.DEFAULT_FONT_SIZE
                            * size_multiplier
                            * layout_engine.LINE_HEIGHT
                        )
                        text_layout.box.height = height
                        text_layout.font_size = (
                            layout_engine.DEFAULT_FONT_SIZE * size_multiplier
                        )
